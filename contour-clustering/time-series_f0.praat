...
form Get time-series F0 data
	text Sound_directory C:\Users\profk\Documents\GitHub\phonology-chuvash\contour-clustering\to_process\
	sentence Sound_file_extension .wav
	text TextGrid_directory C:\Users\profk\Documents\GitHub\phonology-chuvash\contour-clustering\to_process\
	sentence TextGrid_file_extension .TextGrid
	text Output_file C:\Users\profk\Documents\GitHub\phonology-chuvash\contour-clustering\output-di2
		...
		for interval to numberOfIntervals
			...
			if label$ = "ɛ" or label$ = "i" or label$ = "ɑ" or label$ = "ʌ" or label$ = "u" or label$ = "y" or label$ = "ɯ" or label$ = "e"
				...
				if dur > minimum_duration and dur < maximum_duration
					...
					# --- FILTER: Exactly 2 vowels ---
					if total_vowels_in_word = 2
						word_category$ = syll1_cat$ + syll2_cat$
						
						combined_interval_label$ = label$ + ";" + string$(vowel_index) + ";" + current_vowel_cat$ + ";" + word_category$ + ";" + current_vowel_cat$ + "-" + string$(vowel_index) + "-" + word_category$
						...
						# We name the initial pitch object so we can catch it later
						...
						# Smoothing and Interpolating often create NEW objects
						...
						while stepnr <= number_of_measurement_points
							...
							resultline$ = "'soundname$''sep$''combined_interval_label$''sep$''start''sep$''end''sep$''step''sep$''stepnr''sep$''value''sep$''mchange''newline$'"
						...
						nocheck plusObject: smooth_pitch_id
						nocheck plusObject: interp_pitch_id
						nocheck plusObject: pitch_tier_id
						nocheck plusObject: "Sound 'soundname$'_part"
						nocheck Remove
					endif
				endif
				select TextGrid 'soundname$'
